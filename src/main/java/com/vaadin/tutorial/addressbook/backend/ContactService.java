...
public class ContactService {
    ...
    // Create dummy data by randomly combining first， last names and tasks
    ...
    static String[] tasks = {"Save the world", "Eliminate the T-virus", "Take over the earth",
    		"Become a Jouishishi", "Help batman catch the Joker", "Impeach Donald Trump", "Wash dishes", 
    		"Repair the Hidden Blade"};
